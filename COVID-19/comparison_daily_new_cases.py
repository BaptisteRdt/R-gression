...
def split_data(dataset, x, x_test, y, y_test, begin, end):
  for i in range(begin, end):
    if i%3!=0:
      ...
      y_test = np.append(y_test, dataset[i][1])
...
data_board = [
    (first_x, first_x_test, first_y, first_y_test, "April 2020 to December 2020", 8, 60000),
    (second_x, second_x_test, second_y, second_y_test, "January 2021 to November 2021", 7, 45000),
    (third_x, third_x_test, third_y, third_y_test, "December 2021 to April 2022", 7, 450000)
]
...
for this_X, this_X_test, this_y, this_y_test, period, p, y_lim in data_board:
    ...
    for name, estimator in estimators:
        ...
        plt.plot(
            ...
            linewidth=lw,
            label="%s: error = %.3f" % (name, mse/10000000),
        )
